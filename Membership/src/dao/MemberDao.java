...
public class MemberDao {
    ...
    public List<Member> findAll() {
        ...
        try (Connection connection = MySqlConnection.getConnection()) {
            ...
            ResultSet resultSet = statement.executeQuery("SELECT member.id, member.nama, jenis_member.id AS jenis_member_id, jenis_member.nama AS jenis_member_nama FROM member JOIN jenis_member ON jenis_member.id = member.jenis_member_id");
